...
#include <substrate.h>
@class SBMediaController; @class SBAwayController; @class UIView; @class SBApplicationIcon; @class BBServer; @class UIWebView; @class SBAwayBulletinListController; @class SBApplication; @class MPUNowPlayingController; @class SBLockScreenNotificationListController; @class IWWidget; @class SpringBoard; @class SBLockScreenViewController; 
