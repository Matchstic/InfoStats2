...
#include <substrate.h>
@class UIWebView; @class SBAwayController; @class SpringBoard; @class SBMediaController; @class UIView; @class SBApplicationIcon; @class BBServer; @class MPUNowPlayingController; @class IWWidget; @class SBLockScreenNotificationListController; @class SBAwayBulletinListController; @class SBLockScreenViewController; @class SBApplication; 
