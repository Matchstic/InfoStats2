...
#include <substrate.h>
@class SBMediaController; @class IWWidget; @class SBAwayController; @class SBApplicationIcon; @class SBLockScreenNotificationListController; @class UIView; @class SBAwayBulletinListController; @class UIWebView; @class SpringBoard; @class SBApplication; @class SBLockScreenViewController; @class BBServer; 
