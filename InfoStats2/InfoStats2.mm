...
#include <substrate.h>
@class SBApplication; @class UIWebView; @class SBLockScreenNotificationListController; @class SpringBoard; @class SBLockScreenViewController; @class SBAwayController; @class IWWidget; @class SBApplicationIcon; @class BBServer; @class SBAwayBulletinListController; @class SBMediaController; 
