...
#include <substrate.h>
@class SBMediaController; @class SBApplication; @class UIWebView; @class SpringBoard; @class SBLockScreenViewController; @class SBAwayController; @class SBLockScreenNotificationListController; @class BBServer; @class SBAwayBulletinListController; @class IWWidget; @class UIView; @class SBApplicationIcon; 
