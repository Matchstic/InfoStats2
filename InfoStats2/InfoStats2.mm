...
#include <substrate.h>
@class SBAwayBulletinListController; @class SBApplicationIcon; @class SBApplication; @class SBLockScreenNotificationListController; @class IWWidget; @class SBAwayController; @class SBLockScreenViewController; @class UIWebView; @class BBServer; @class SpringBoard; @class SBMediaController; 
