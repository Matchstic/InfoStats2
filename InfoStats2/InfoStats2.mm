...
#include <substrate.h>
@class SBAwayController; @class SBAwayBulletinListController; @class MPUNowPlayingController; @class SBMediaController; @class SBApplicationIcon; @class SBLockScreenViewController; @class IWWidget; @class UIWebView; @class UIView; @class SBApplication; @class SpringBoard; @class SBLockScreenNotificationListController; @class BBServer; 
...
#line 104 "/Users/Matt/iOS/Projects/InfoStats2/InfoStats2/InfoStats2.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_5f73d052() {
