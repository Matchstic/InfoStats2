...
#include <substrate.h>
@class BBServer; @class SBApplication; @class UIView; @class SBApplicationIcon; @class SBLockScreenNotificationListController; @class SBLockScreenViewController; @class SBMediaController; @class SBAwayBulletinListController; @class SBAwayController; @class UIWebView; @class IWWidget; @class SpringBoard; 
