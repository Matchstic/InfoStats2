...
#include <substrate.h>
@class SBLockScreenViewController; @class SBAwayBulletinListController; @class SBApplicationIcon; @class SBApplication; @class SBMediaController; @class SBAwayController; @class SpringBoard; @class IWWidget; @class BBServer; @class UIWebView; @class SBLockScreenNotificationListController; 
...
static __attribute__((constructor)) void _logosLocalCtor_6b8d4a4e() {
