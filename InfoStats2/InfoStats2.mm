...
#include <substrate.h>
@class MPUNowPlayingController; @class SBLockScreenViewController; @class SBApplication; @class SBLockScreenNotificationListController; @class IWWidget; @class SBAwayController; @class BBServer; @class SBMediaController; @class SpringBoard; @class SBAwayBulletinListController; @class UIView; @class UIWebView; @class SBApplicationIcon; 
