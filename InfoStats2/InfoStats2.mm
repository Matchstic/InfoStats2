...
#include <substrate.h>
@class MPUNowPlayingController; @class SBAwayController; @class UIWebView; @class SBAwayBulletinListController; @class IWWidget; @class SBLockScreenViewController; @class BBServer; @class SBApplicationIcon; @class SpringBoard; @class SBApplication; @class UIView; @class SBMediaController; @class SBLockScreenNotificationListController; 
