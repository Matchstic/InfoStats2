...
#include <substrate.h>
@class UIView; @class SBAwayController; @class SpringBoard; @class BBServer; @class IWWidget; @class SBMediaController; @class SBApplicationIcon; @class SBLockScreenNotificationListController; @class SBAwayBulletinListController; @class SBApplication; @class SBLockScreenViewController; @class UIWebView; 
