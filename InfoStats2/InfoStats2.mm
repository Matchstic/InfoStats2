...
#include <substrate.h>
@class SBLockScreenNotificationListController; @class UIWebView; @class SBMediaController; @class IWWidget; @class SBApplicationIcon; @class SpringBoard; @class SBLockScreenViewController; @class SBApplication; @class UIView; @class BBServer; @class SBAwayBulletinListController; @class SBAwayController; 
...
static __attribute__((constructor)) void _logosLocalCtor_e4c35f91() {
