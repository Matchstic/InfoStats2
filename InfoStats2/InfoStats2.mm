...
#include <substrate.h>
@class SBApplicationIcon; @class SpringBoard; @class SBApplication; @class BBServer; @class SBLockScreenNotificationListController; @class SBAwayController; @class IWWidget; @class SBLockScreenViewController; @class UIWebView; @class SBAwayBulletinListController; @class SBMediaController; 
