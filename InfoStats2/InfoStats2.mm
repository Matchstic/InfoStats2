...
#include <substrate.h>
@class SBApplication; @class SpringBoard; @class SBLockScreenViewController; @class UIView; @class SBApplicationIcon; @class SBAwayController; @class MPUNowPlayingController; @class UIWebView; @class SBLockScreenNotificationListController; @class BBServer; @class IWWidget; @class SBAwayBulletinListController; 
