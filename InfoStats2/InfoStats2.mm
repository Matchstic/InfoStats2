...
static void _logos_method$_ungrouped$SBLockScreenManager$_handleBacklightLevelChanged$(_LOGOS_SELF_TYPE_NORMAL SBLockScreenManager* _LOGOS_SELF_CONST self, SEL _cmd, NSNotification* arg1) {
    _logos_orig$_ungrouped$SBLockScreenManager$_handleBacklightLevelChanged$(self, _cmd, arg1);
